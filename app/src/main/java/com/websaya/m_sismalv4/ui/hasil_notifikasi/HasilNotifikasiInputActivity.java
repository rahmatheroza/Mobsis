...
import com.websaya.m_sismalv4.ui.fokus_aktif.FokusAktifDatePickerFragment;

public class HasilNotifikasiInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kasus_indigenous_form);
...
//        mEditDesaPasien = findViewById(R.id.editTextDesaPasien);
    ...
    public void showDatePicker(View view) {
        if (view.getId() == R.id.buttonTanggalKunjungan1)
            ...
            datePickerIdx = 0;
        DialogFragment newFragment = new HasilNotifikasiDatePickerFragment();
